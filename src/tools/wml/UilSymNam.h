...
externaldef(uil_sym_glbl) int uil_max_object = 87;
...
externaldef(uil_sym_glbl) int uil_max_arg = 699;
...
externaldef(uil_sym_glbl) int uil_max_reason = 78;
...
externaldef(uil_sym_glbl) int uil_max_enumval = 397;
...
externaldef(uil_sym_glbl) int uil_max_charset = 23;
